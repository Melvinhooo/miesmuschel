...
window.__MIESMUSCHEL_LESSONS = {
  ...
  "lessons": [
    ...
    },
    {
      ...
      "lesson": "Aufstellung erst 1h vor Anstoss abrufen — Torschuetzen-Tipps auf Einwechselspieler fast nie gewonnen (Thuram-Fall v13).",
      "bezug_spiel_id": null
    },
    {
      "datum": "2026-04-23",
    ...
    },
    {
      ...
      "lesson": "Double-Double nur dann als VALUE wenn BEIDE Stats (meist Pkt + Reb) realistisch auf 10+ zusteuern. Banchero 22.04. mit 18/6/8 — nur Punkte zweistellig. Saisonschnitt 21/8 bedeutet Rebounds sind KEIN Selbstlaeufer. Bei DD-Tipps Verteilung der zweiten Statistik checken, nicht nur den Schnitt.",
      "bezug_spiel_id": "2026-04-22-pistons-magic"
    },
    {
      "datum": "2026-04-23",
      "kategorie": "Under-Tipps bei einseitigem Spiel",
      "lesson": "Under-Totals nur wenn BEIDE Teams defensiv/langsam spielen. Thunder-Suns 22.04.: Under 215.5 verloren (227 gesamt), weil Suns als Underdog offen spielen mussten. Regel: Bei grossem Favoriten (Spread > 10) ist das Under-Risiko real — Underdog geht All-Out auf Tempo.",
      "bezug_spiel_id": "2026-04-22-thunder-suns"
    },
    {
      "datum": "2026-04-24",
      "kategorie": "Sweep-Abwehr-Heimsieg",
      "lesson": "Bei 0-2 Serienstand explodiert das Heimteam oft in G3. Raptors als -5.5-Dog gegen 2-0-Cavs gewannen 126:104 (Upset +22 ggü. Linie). Regel: Sieg-Tipp auf den Auswaerts-Favoriten bei Sweep-Druck NICHT als SAFE markieren — max VALUE. Bei -150 oder niedriger Moneyline eher Finger weg und lieber ueber/unter-Total spielen.",
    ...
    },
    {
      ...
      "lesson": "GOLDGRUBE-IDENTIFIZIERUNG: Conference League Halbfinale aktuell 4/4 = 100% ROI +69.5% nach 30.04. Beide Heim-PL/LaLiga-Klubs (Crystal Palace im Glasner-System / Rayo Vallecano in Vallecas) gewannen, beide DC-1X bzw. DC-X2 + beide direkter Sieg gewannen. Markt-Bilanz 'Crystal Palace DC X2' + 'Crystal Palace Sieg' + 'Rayo DC 1X' + 'Rayo Sieg' alle 4/4. Pattern: PL/LaLiga-Mid-Table-Klubs gegen Ukraine-Pokal/Ligue-1-Mid-Klubs in Hinspiel-Heim-Konstellation = klare Klassen-Edge. REGEL fuer naechste Conference-Hinspiele (07.05. Strasbourg-Rayo + Crystal Palace-Shakhtar Rueckspiele!): bei Heim-Vorteil PL/LaLiga-Klub gegen niedrigere Liga = SAFE-DC oder VALUE-Sieg legitim. Bei Auswaerts-Vorteil PL-Klub gegen niedrigere Liga (z.B. Palace im Rueckspiel zuhause): X2-DC SAFE. Aktiv suchen statt vermeiden. NICHT verwechseln mit Europa League: dort 3/5 = 60% ROI -19% (Forest-Villa unterperformt — All-PL-Duelle ohne Klassendifferenz sind nicht im gleichen Edge-Range). Conference > Europa fuer Klassendifferenz-Edge.",
    ...
    },
    {
      ...
      "lesson": "ERFOLGS-VALIDIERUNG #2 + EXTENSION: Layer-2 (Sieg-Outcomes nur in Safe-Kombi) wirkte erneut. Safe-Kombi (4x DC) gewann @ 3.17 (Netto +2.17), trotz dass 3 von 4 anderen Kombis verloren. Diversifikation funktionierte: ein einzelner Spiel-Killer haette nicht alle 4 Kombis genommen. ABER neuer Befund: Forest-Villa-Hinspiel-BTTS-These war in Balance-Kombi UND Moonshot-Kombi — riss beide simultan, weil dieselbe Spiel-These auf 2 Kombis verteilt war (Layer-2 Markttyp-Diversifikation, aber Layer-3 Spiel-These-Konzentration). Kein direkter Sieg-Outcome-Doppel, aber Korrelations-Effekt ueber das Game-Outcome. NEUE REGEL Layer-3: Wenn dieselbe Game-Theses (z.B. 'BTTS in Spiel X') in 2 Kombis vorkommt, sind diese Kombis korreliert auch wenn der Markttyp identisch ist. Vermeiden: identische Spiel/Markt-Kombination in 2+ Kombis. Heute Konsequenz: Forest-Villa-BTTS gehoerte nur in Moonshot (Spass) ODER nur in Balance (substanziell), nicht in beide. REGEL: Spiel/Markt-Bein darf max 1x ueber alle Kombis hinweg verwendet werden — Layer-3 erweitert Layer-2 (Sieg-Outcome-Konzentration) auf Marktduplikate. Das senkt die Total-Korrelation zwischen Kombis nochmal. Aktuell 8/12 Einzeltipps + Safe-Kombi @ +2.17 = klar profitabler Tag trotz 3/4 Kombi-Verluste.",
    ...
    {
      "datum": "2026-05-08",
      "kategorie": "HR22: Star-OUT-Aufhol-Pflicht-Implosion (Quelle 8h — Rotation-Pattern)",
    ...
    {
      "datum": "2026-05-08",
      "kategorie": "HR23: Layer-3-Diversifikation (max 1 Bein pro Spiel ueber ALLE Kombis hinweg, Quelle 8a — Korrelations-Analyse)",
    ...
    {
      "datum": "2026-05-26",
      "kategorie": "K.o.-Entscheidungsspiel: 'Sieg reguläre Spielzeit'-Falle bei Verlängerungs-Option",
      "lesson": "NEU nach Paderborn-Wolfsburg Relegations-Rueckspiel 25.05 (regulaer 1:1, 2:1 n.V., Paderborn aufgestiegen): Der Sieg-Tipp 'Paderborn reguläre Spielzeit' @1.85 VERLOR, obwohl Paderborn aufstieg - das entscheidende Tor (Curda) fiel erst in der 100. Minute (Verlängerung), reguläre Zeit endete 1:1. REGEL: In Coinflip-K.o.-Spielen mit Verlängerungs-Option (Relegation, Pokal-Rueckspiel bei Gleichstand, Hin/Rueck-Aggregat) ist der Standard-1X2-Sieg-Tipp 90-Min-Settlement - bei ausgeglichenen Quoten (~1.85/3.40/2.05) ist die Verlängerungs-/Remis-Wahrscheinlichkeit in regulärer Zeit hoch, der Sieg-Tipp verliert also auch wenn das Team am Ende weiterkommt. Wenn man auf das Weiterkommen setzen will: 'Wer kommt weiter / steigt auf'-Markt (inkl. Verlängerung+Elfer) waehlen, NICHT den 90-Min-Sieg. Defensiv-Maerkte (Unter 2.5: gewonnen, reguläre 2 Tore) und Torschützen Jederzeit (Bilbija 38.: gewonnen) sind in solchen Spielen die robusteren Tipps.",
      "bezug_spiel_id": "2026-05-25-pad-wob"
    },
    {
      "datum": "2026-05-26",
      "kategorie": "Goldgrube-Priorität validiert: an dünnem Coinflip-Tag trugen nur die Goldgrube-Märkte",
      "lesson": "ERFOLGS-VALIDIERUNG: Am duennen 2-Spiele-Coinflip-Tag 25.05 gewannen AUSSCHLIESSLICH die beiden Goldgrube-Markt-Tipps: Unter 2.5 Tore (13 Tipps / 69.2% / +37.2% ROI - Paderborn regulär 1:1) und Torschützen Jederzeit (43 Tipps / 39.0% / +24.1% ROI - Bilbija 38.). ALLE Nicht-Goldgrube-Fliers verloren: Paderborn-Sieg-regulär, Cavs-ML, NBA-Unter 217.5. Netto: Einzeltipps +4.26€ (komplett aus den 2 Goldgruben), Kombis -5.80€ (beide gezogen vom NBA-Game). REGEL bestätigt: an dünnen Slates ohne klaren Favoriten-Spot die Goldgrube-Märkte (Unter 2.5, Torschützen Jederzeit, Über 2.5, DC X2) als Haupt-Einzeltipps priorisieren und Sieg-Outcome-Fliers (Coinflip-1X2, NBA-ML) auf Mini-Stake/Kombi-Bein begrenzen. Die Goldgrube-Disziplin ist der ROI-Anker an chaotischen Tagen.",
      "bezug_spiel_id": "2026-05-25-pad-wob"
    },
    {
      "datum": "2026-05-26",
      "kategorie": "Mini-Spiele-Tag-Korrelation: 1 Game in jeder Kombi = Single-Point-of-Failure",
      "lesson": "KORRELATIONS-BEFUND (Kombi-Verluste 25.05): Beide Kombis verloren, beide am SELBEN Spiel. kombi-balance (Unter 2.5 PAD + Unter 217.5 NBA) verlor nur am NBA-Bein (Football-Unter gewann); kombi-risiko (Paderborn-Sieg + Cavs-ML) verlor u.a. am NBA-Bein. Bei nur 2 Spielen ist jedes Spiel mathematisch in JEDER Kombi -> das NBA-Game (Blowout, +37) war Single-Point-of-Failure und kippte beide Kombis simultan, obwohl Layer-1 (max 1 Bein/Spiel) eingehalten war. VERSCHÄRFUNG Mini-Spiele-Tag-Cap (Lessons 19./21.05): Bei <=2 in-scope-Spielen sind 2 Kombis faktisch hoch korreliert (ein Spiel-Outcome steckt in beiden). REGEL: Bei genau 2 Spielen MAXIMAL 1 Kombi spielen (das saubere Tor-Total-Doppel als Balance), keine zweite Sieg-Outcome-Kombi - die zusätzliche Kombi addiert Korrelations-Risiko ohne echte Diversifikation. Lieber Einsatz auf die Goldgrube-Einzeltipps konzentrieren.",
      "bezug_spiel_id": "2026-05-25-cle-nyk"
    },
    {
      "datum": "2026-05-27",
    ...
    },
    {
      ...
      "lesson": "EMPIRISCHE VALIDIERUNG der Lesson 28.05. (Mini-Spiele-Tag Goldgrube-Stake-Konzentration) plus NBA-Double-Double-Markt als robuster HR16-konformer Anker: Heutiger 1-Spiel-Tag (SAS-OKC G6 nur) mit Stake-Konzentration 1.5% auf hoechste-Edge SAS-ML + 2x 0.5% auf Unter/DD lieferte 3/3 Einzeltipps gewonnen + 1/1 spiele[].tipps[]-Block (Wemby O25.5) = 4/4 Tipps. Tages-ROI: 9.13€/13.75€ = +66.4% bei nur 2.5% Kasse-Exposure - perfekter Mini-Spiele-Tag-Verlauf. KERNVALIDIERUNG: (a) NBA-DD-Markt (HR16-konform, nicht im Bluter) @ 1.55 fuer Wemby = robuster Anker bei Star-Centern mit Saison-Avg ueber 25P + 10R - Trefferquote intuitiv >70% bei vollen Minuten, traegt sich mathematisch. (b) Stake-Konzentration auf Top-Edge (1.5% statt 3x 0.5% gleichverteilt) war richtig - SAS-ML brachte 5.12€ Netto-Loewenanteil (von 9.13€ Gesamt-Netto). (c) Single-Game-Korrelations-Risiko (alle Beine im selben Spiel) hier durch konservatives Gesamt-Exposure 3% Kasse abgesichert - mit Vorausschau-Cap reden vs. Mini-Tag-Risk-Profil neu kalibrieren? STRATEGIE fuer NBA-G7-Tag (30.05): wieder Mini-Spiele-Tag-Profil (CL-Finale + NBA-G7 = 2-Spiele-Tag), Single-Game-Cap 3% nicht ueberschreiten + NBA-DD-Markt als 'NBA-Anker-Goldgrube-Kandidat' aktiv suchen (sample-size n wachsen lassen).",
      "bezug_spiel_id": "2026-05-28-okc-sas"
    },
    {
      "datum": "2026-05-30",
    ...
    },
    {
      ...
      "lesson": "DRITTE VALIDIERUNG: Lesson 06.06. 'Klassen-Edge realisiert sich als Sieg statt Tor-Anzahl' wurde heute n=3 weiter bestaetigt. Drei Klassen-Edge-Sieg-Tipps gesetzt - alle 3 GEWONNEN: (1) Kroatien Sieg @1.36 (FIFA10 vs FIFA44) → 2:1 knapper Spaet-Sieg via Pasalic-Joker 90+3. (2) Ecuador Sieg @1.30 (FIFA23 vs FIFA105) → 3:0 souveraen sogar OHNE Stamm-Achse Pacho/M.Caicedo/Hincapie (alle Bank). (3) Italien-U22 DC X2 @1.55 (Klassen-Edge vs Griechen-Form-Krise) → 0:1 Sieg via Esposito 18'. PARALLEL: BTTS MAR-NOR @1.68 gewann (1:1), Unter 2.5 GRE-ITA @1.75 gewann (0:1 = 1 Tor), Unter 3.5 ECU-GUA @1.40 gewann (3:0). NEGATIV-PATTERN: Tor-Anzahl-Tipps (Ueber 2.5 MAR-NOR, Torschuetzen) verloren - genau wie Lesson 06.06. erwartet. ZUSAMMEN-STRATEGIE BESTAETIGT: In pre-Turnier-Friendlies mit Klassen-Edge ist Sieg-Tipp signifikant zuverlaessiger als Tor-Markt. Sieg-VALUE-Bilanz WM-Tests jetzt n=8 / 8/8 = 100% / +66% ROI seit Lesson-Anwendung. Lesson erhaelt 'STRATEGISCHES PRIMAERPATTERN'-Status, taeglich Pflicht in Tipps-Routine.",
